  ...
  Future getCurrentWeather() async {
    ...
    try {
      final res = await http.get(Uri.parse(
          'https://api.openweathermap.org/data/2.5/forecast?q=$cityname&APPID=114b3afbbff214cffd8f4a512cb843f2'),
        ...
        actions:  [
          ...
          body: isloading ? const LinearProgressIndicator(color: Colors.red,backgroundColor: Colors.black87,):  Padding(
            ...
            const Row(
              ...
              children: [
                 Text('Above information is about City Kangra', style: TextStyle(
                  fontSize: 20,
                  fontWeight: FontWeight.bold
